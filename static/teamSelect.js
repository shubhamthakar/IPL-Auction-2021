...
var input = document.getElementById("fixedDiv");
...
var checkName = function () {
  ...
  if (newPlayer == "Mario") {
    window.location.href = '/waitingpg';
    ...
    playerDiv.innerHTML +=
      ...
      '<div class="wrapper">' +
      '<div class="fut-player-card" style="background-image:linear-gradient(' +
      ...
      countryImage +
      '" alt="Nation" draggable="false"/></div>' +
      ...
      "</span></div>" +
      "</div>" +
      '<div  style="width:30px;height:30px;"><img  class="crossImage" src="/static/closeButton.jpg" alt="Virat" draggable="false" style="width: 100%" onclick="remPlayer(' +
      "'" +
      newPlayer +
      "'" +
      ',this)"/></div>' +
    ...
    if (selectedPlayers.length < 11) {
      ...
      console.log("Criteria fullfilled");
      ...
      catInputFunction();
      playerCountDiv.innerHTML =
        "You can now procced and click on <span class='formNext'><a href='#moveDown'>NEXT</a></span>";
    } else {
      playerCountDiv.innerHTML =
  ...
  if (selectedPlayers.length == 11) {
    ...
    if (checkCategoryCondition(category, playerName)) {
      ...
      newDiv.innerHTML +=
        ...
        '<div class="col-lg-9">' +
        '<h2 style="font-size:1.25rem; padding: 0.5rem">' +
        playerName +
        " - " +
        playerBonus +
        "</h2>" +
        "</div>" +
        '<div class="col-lg-3">' +
        '<div  style="width:2.3rem;height:2.3rem; padding: 0.5rem">' +
...
var changeBonusRuleBox = function () {
  console.log("hii");
  if (document.getElementById("ruleDiv2").className == "positionDown") {
    document.getElementById("ruleDiv2").classList.remove("positionDown");
    document.getElementById("ruleDiv2").classList.add("positionUp");
    ...
    setTimeout(function () {
      document.getElementById("ruleDiv2").classList.remove("positionUp");
      document.getElementById("ruleDiv2").classList.add("positionDown");
    }, 200);
  }
};
...
var changeChoseDivPos = () => {
  ...
  if (state == "out") {
    ...
    playersSelectedDiv.style.right = "-14rem";
